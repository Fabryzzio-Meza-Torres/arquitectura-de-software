...
How each persona should experience the Lea$e platform. This section calibrates flow
completeness: it describes the *feel* and the *guarantees* the user expects, not the
step-by-step (that lives in `MainFlows.md`). Grounded in `people/Cesar.md` and
`people/JuanPedro.md`.

## Principles that apply to both users
...
## César — Head of Finance (client)

César logs in with a project deadline pressing on him and tight cash flow. His experience
should feel like the **opposite of a traditional bank credit process**: fast, transparent,
and predictable.

What he should be able to do without friction:
...
5. **Be notified** of anything that affects what he owes: upcoming/overdue installments and
   any **exchange-rate change** on his contract (with the before/after and the reason).
...
## Experience quality bar (qualitative, refined into numbers in `AcceptanceCriteria.md`)
